...
int main()
{
	...
	map.setMapSize(18); //Integer length, in grid spaces, of one side of the square map
	int seedBlobCount{ 50 }; //Starting number of Blobs
	...
	int dayCount{ 125 }; //Length of simulation in days
	int simCount{ 2 }; //Number of repeat simulations run
